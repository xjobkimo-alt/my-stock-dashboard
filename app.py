...
with row1_col1:
    ...
    with tab_portfolio:
        ...
        /* 隱形骨架：把刪除按鈕的原生灰色大外框徹底壓扁抹除 */
        .xq-pure-del-wrapper button {
        ...
        .xq-pure-del-wrapper button:hover {
            color: #FF8A80 !important;
            background: transparent !important;
        }
        </style>
        ...
        # 1. 表頭欄位比例微調，將寬度牢牢鎖死 [2.6, 1.3, 1.3, 1.3, 1.3, 1.3, 0.6]
